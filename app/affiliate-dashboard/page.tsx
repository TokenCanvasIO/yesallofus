...
useEffect(() => {
  ...
  const navItems = [
    ...
    { id: 'tap-to-pay', label: 'Tap-to-Pay', icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg> },
...
<div ref={rightColumnRef} id="top-up" className="bg-zinc-900/70 border border-zinc-800 rounded-xl p-4 sm:p-5 h-full">
  ...
  <span>Auto-pay limit: <strong className="text-white">£25</strong> per transaction</span>
                          ...
                          {loginMethod === 'web3auth' ? (
                            ...
                            }} className="w-full bg-white hover:bg-zinc-100 text-black font-semibold py-3 rounded-xl transition flex items-center justify-center gap-3">
                        ...
                        <div className="px-0 py-3">
                          ...
                          {loginMethod === 'crossmark' ? (
                            ...
                            <>
                              ...
                              }} className="w-full bg-white hover:bg-zinc-200 text-black py-3 rounded-lg text-sm font-medium transition-colors">Connect Browser Wallet</button>
