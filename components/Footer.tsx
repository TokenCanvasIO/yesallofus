        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-8 lg:mb-0">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.linkedin.com/in/mark-flynn-b00990304/" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/dashboard" className="text-zinc-400 hover:text-white transition-colors text-sm">For Stores</a></li>
              ...
              <li><a href="/#get-started" className="text-zinc-400 hover:text-white transition-colors text-sm">Get Started</a></li>
            </ul>
          </div>
